...
class QuizSeeder4 extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Quiz::insert([
            ...
            [
                "question" => 'When you think something is too expensive, you say:',
                "module_id" => 4,
            ...
            [
                "question" => 'The most respectful way to say "I want to buy" is:',
                "module_id" => 4,
                "type_id" => 1, // Multiple Choice
            ...
            [
                "question" => 'A respectful term for something you\'ve purchased is:',
                "module_id" => 4,
                "type_id" => 2, // Fill in the Blank
                "answer" => "Kintunan.",
                "is_learning" => true,
            ...
            [
                "question" => 'To respectfully ask if an elder wants something, you use the word:',
                "module_id" => 4,
                "type_id" => 2, // Fill in the Blank
                "answer" => "Kersa.",
                "is_learning" => true,
            ...
            [
                "question" => 'The highest form of "Thank you" after a transaction is:',
                "module_id" => 4,
                "type_id" => 1, // Multiple Choice
            ...
            [
                "question" => 'The respectful term for handing over payment is:',
                "module_id" => 4,
                "type_id" => 1, // Multiple Choice
                "answer" => "Marasakeun",
                "is_learning" => false,
            ...
            [
                "question" => 'A respectful term for a purchase you take home is:',
                "module_id" => 4,
                "type_id" => 2, // Fill in the Blank
                "answer" => "Kintunan.",
                "is_learning" => false,
            ...
            [
                "question" => 'Which word means "to wish/want" when referring to an elder?',
                "module_id" => 4,
                "type_id" => 1, // Multiple Choice
                "answer" => "Kersa",
                "is_learning" => false,
            ...
            [
                "question" => 'You are buying snacks from a street vendor your age. How do you ask for the price?',
                "module_id" => 4,
                "type_id" => 1, // Multiple Choice
                "answer" => "Iki pira?",
                "is_learning" => false,
            ...
            [
                "question" => 'You are at a traditional market buying batik from a middle-aged shop owner. How do you politely ask for a discount?',
                "module_id" => 4,
                "type_id" => 1, // Multiple Choice
                "answer" => "Angsal kirang, mboten?",
                "is_learning" => false,
            ...
            [
                "question" => 'You are helping your grandmother buy a gift for her friend from a respected artisan. How do you say "We would like to purchase this"?',
                "module_id" => 4,
                "type_id" => 1, // Multiple Choice
            ...
            [
                "question" => 'After buying from a friendly shopkeeper at the market, you receive your change. What is the polite term for this change?',
                "module_id" => 4,
                "type_id" => 1, // Multiple Choice
                "answer" => "Wangsulan",
                "is_learning" => false,
            ...
            [
                "question" => 'A student is buying a book from a polite bookstore clerk. The student says: "Mbak, iki pira?" Which part of the question is too casual?',
                "module_id" => 4,
                "type_id" => 1, // Multiple Choice
                "answer" => "iki pira",
                "is_learning" => false,
            ...
            [
                "question" => 'You are at a formal gallery. You respectfully ask the curator: "Pak, kula tumbas lukisan niki." Which phrase is not respectful enough for this formal situation?',
                "module_id" => 4,
                "type_id" => 1, // Multiple Choice
                "answer" => "kula tumbas",
                "is_learning" => false,
            ...
            [
                "question" => 'To politely ask "How much for everything?" at a market stall, you say: Pinten ______',
                "module_id" => 4,
                "type_id" => 2, // Fill in the Blank
                "answer" => "sedanten",
                "is_learning" => false,
            ...
            [
                "question" => 'A very respectful way to begin an inquiry with an elder artisan is: Nyuwun ______',
                "module_id" => 4,
                "type_id" => 2, // Fill in the Blank
                "answer" => "pirsa",
                "is_learning" => false,
