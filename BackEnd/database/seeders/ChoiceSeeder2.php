...
class ChoiceSeeder2 extends Seeder
{
    ...
    {
        // Truncate only if this seeder is meant to be run in isolation or
        // if you want to clear choices related to module 2 specifically.
        // If DatabaseSeeder handles all truncates, you can remove this.
        Choice::whereIn('quiz_id', range(54, 106))->delete(); // Clear only choices for module 2 quizzes

        // Start ID for Module 2 quizzes, assuming Module 1 ended at ID 53
        $currentQuizId = 54;
        ...
        Choice::insert([
            ...
            [
                "quiz_id" => $currentQuizId++, // ID 55
                "text" => "Sapa jenengmu?",
            ],
            [
                "quiz_id" => $currentQuizId - 1,
                "text" => "Omahmu ngendi?",
            ],
